...
I'm just a formr super fan, so I made this talk to share it with the rest of the R universe and demonstrate a few ways of how I've used it.
...
Or you could use R code to generate dynamic feedback about the answers a respondent gave.

This chart, for example, was dynamically generated based on the answers a respondent gave to a set of questions about their risk preferences, giving them feedback about how they compare to others.
...
Formr relies on a spreadsheet format to input content for each survey.
...
Depending on the type of question, you may also have some options for respondents to choose from, like a multiple choice question.
